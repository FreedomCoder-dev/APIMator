...
public class CloneVisitor implements GenericVisitor<Node, Object> {
	...
	public Node visit(CompilationUnit _n, Object _arg) {
		...
		return new CompilationUnit(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), package_, imports, types, comments);
	}
	...
	public Node visit(ClassOrInterfaceDeclaration _n, Object _arg) {
		...
		ClassOrInterfaceDeclaration r = new ClassOrInterfaceDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, _n.isInterface(), _n.getName(), typeParameters, extendsList, implementsList, members);
		return r;
	}
	...
	public Node visit(EnumDeclaration _n, Object _arg) {
		...
		List<BodyDeclaration> members = visit(_n.getMembers(), _arg);
		EnumDeclaration r = new EnumDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, _n.getName(), implementsList, entries, members);
		return r;
	}
	...
	public Node visit(EmptyTypeDeclaration _n, Object _arg) {
		JavadocComment javaDoc = cloneNodes(_n.getJavaDoc(), _arg);
		EmptyTypeDeclaration r = new EmptyTypeDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc);
		return r;
	}
	...
	public Node visit(EnumConstantDeclaration _n, Object _arg) {
		...
		EnumConstantDeclaration r = new EnumConstantDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, annotations, _n.getName(), args, classBody);
		return r;
	}
	...
	public Node visit(AnnotationDeclaration _n, Object _arg) {
		...
		List<AnnotationExpr> annotations = visit(_n.getAnnotations(), _arg);
		List<BodyDeclaration> members = visit(_n.getMembers(), _arg);
		AnnotationDeclaration r = new AnnotationDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, _n.getName(), members);
		return r;
	}
	...
	public Node visit(AnnotationMemberDeclaration _n, Object _arg) {
		...
		AnnotationMemberDeclaration r = new AnnotationMemberDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, type_, _n.getName(), defaultValue);
		return r;
	}
	...
	public Node visit(FieldDeclaration _n, Object _arg) {
		...
		FieldDeclaration r = new FieldDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, type_, variables);
		return r;
	}
	...
	public Node visit(ConstructorDeclaration _n, Object _arg) {
		...
		ConstructorDeclaration r = new ConstructorDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, typeParameters, _n.getName(), parameters, throws_, block);
		return r;
	}
	...
	public Node visit(MethodDeclaration _n, Object _arg) {
		...
		MethodDeclaration r = new MethodDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.getModifiers(), annotations, typeParameters, type_, _n.getName(), parameters, _n.getArrayCount(), throws_, block, _n.isDefault());
		return r;
	}
	...
	public Node visit(EmptyMemberDeclaration _n, Object _arg) {
		JavadocComment javaDoc = cloneNodes(_n.getJavaDoc(), _arg);
		EmptyMemberDeclaration r = new EmptyMemberDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc);
		return r;
	}
	...
	public Node visit(InitializerDeclaration _n, Object _arg) {
		JavadocComment javaDoc = cloneNodes(_n.getJavaDoc(), _arg);
		BlockStmt block = cloneNodes(_n.getBlock(), _arg);
		InitializerDeclaration r = new InitializerDeclaration(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), javaDoc, _n.isStatic(), block);
		return r;
	}
	...
	public Node visit(ClassOrInterfaceType _n, Object _arg) {
		...
		ClassOrInterfaceType r = new ClassOrInterfaceType(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), scope, _n.getName(), typeArgs, ann);
		return r;
	}
	...
	public Node visit(PrimitiveType _n, Object _arg) {
		List<AnnotationExpr> ann = visit(_n.getAnnotations(), _arg);
		PrimitiveType r = new PrimitiveType(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), _n.getType(), ann);
		return r;
	}
	...
	public Node visit(VoidType _n, Object _arg) {
		List<AnnotationExpr> ann = visit(_n.getAnnotations(), _arg);
		VoidType r = new VoidType(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), ann);
		return r;
	}
	...
	public Node visit(WildcardType _n, Object _arg) {
		...
		List<AnnotationExpr> ann = visit(_n.getAnnotations(), _arg);
		WildcardType r = new WildcardType(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), ext, sup, ann);
		return r;
	}
	...
	public Node visit(LambdaExpr _n, Object _arg) {
		...
		LambdaExpr r = new LambdaExpr(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), lambdaParameters, body, _n.isParametersEnclosed());
	...
	public Node visit(MethodReferenceExpr _n, Object arg) {
		...
		MethodReferenceExpr r = new MethodReferenceExpr(_n.getBeginLine(), _n.getBeginColumn(), _n.getEndLine(), _n.getEndColumn(), scope, typeParams, _n.getIdentifier());
		return r;
	}
	...
	public Node visit(IntersectionType n, Object arg) {
		...
		IntersectionType r = new IntersectionType(n.getBeginLine(), n.getBeginColumn(), n.getEndLine(), n.getEndColumn(), bounds);
		return r;
	}
}
